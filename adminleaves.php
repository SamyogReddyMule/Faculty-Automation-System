	...
	<?php
			...
			while($ld = mysqli_fetch_array($lr))
			{
				...
				?>
					<tr>
						...
						<th><a style="text-decoration: none;" onclick="javascript: return confirm('Do you want to delete the leave');" href="adminleaves.php?del0=<?php echo $a; ?>&del1=<?php echo $a1; ?>&del2=<?php echo $a2; ?>&del3=<?php echo $a3; ?>"> X </a></th>
               		</tr>
            <?php
      		}
      	}
	 ...
	 <form class="f1" id="f1" action="" method="POST" style="display: none" enctype="multipart/form-data">
    	...
    	if(isset($_POST['add']))
		{
			...
			if(mysqli_num_rows(mysqli_query($con, $sql2)) == 1)
			{
				echo '<script>alert("Leave details already in Database"); location.href="adminleaves.php";</script>';
			}
		}
			if(mysqli_num_rows(mysqli_query($con, $qsa2)) != 1)
			{
				echo '<script>alert("Faculty doesnt seem to care!"); location.href="adminleaves.php";</script>';
			}
		}
		...
		if(mysqli_num_rows(mysqli_query($con, $uqsa2)) == 1)
			{
				echo '<script>alert("Faculty id doesnt found in the database"); location.href="adminleaves.php";</script>';
			}
		}
