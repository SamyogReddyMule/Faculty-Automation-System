	...
	<div style="padding-top: 10px; justify-content: center; display: flex; ">
		...
		while($fd = mysqli_fetch_array($fr))
		{
			...
			while($ed = mysqli_fetch_array($er))
			{
					...
					<tr>
						...
						<th><a style="text-decoration: none;" href="adminedu.php?upd0=<?php echo $a; ?>&upd1=<?php echo $a1; ?>&upd2=<?php echo $a2; ?>&upd3=<?php echo $a3; ?> "> Y </a></th>
	 ...
	 <form class="f1" id="f1" action="" method="POST" style="display: none" enctype="multipart/form-data">
    	...
    	if(isset($_POST['add']))
		{
			...
			{
				echo '<script>alert("Faculty doesnt be found from the above given Unique ID"); location.href="adminedu.php";</script>';
			}
		}
		...
		if(isset($_POST['change']))
		{
			...
			if(mysqli_num_rows(mysqli_query($con, $uqsa2)) != 1)
			{
				echo '<script>alert("Please Check the Faculty ID, it doesnt seem to have any data on it."); location.href="adminedu.php";</script>';
			}
		}
