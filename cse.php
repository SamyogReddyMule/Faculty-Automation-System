<style>
  html { 
  background: url(Images/cse_dept.jpg) no-repeat center center fixed; 
  ...
  <ul style="margin: 0px 0px 0px 0px;" class="u1">
    ...
    <li class="l1"><a class="a1" >Login</a>
      <ul class="u2" style="margin: 0px 0px 0px 0px;">
        <li class="l2"><a class="a1" href="csefacultylogin.php">Faculty</a></li>
        <li class="l2"><a class="a1" href="cseadminlogin.php"> Department Administrator</a></li>
      </ul>
    </li>        
      </ul>
    </li>
