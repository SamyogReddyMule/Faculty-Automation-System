...
<body>       
		...
		$pjcr = mysqli_query($con, $pjc);
                ...
                $sk = "SELECT *FROM skills where cuid='$fuid' ";
                $skr = mysqli_query($con, $sk);
        ...
        ?>
                ...
                <h3 class="h2" id="rcorners2" > Workshop </h3>
                <table id="t1" class="cert">
                        <tr>
                                <th> Title </th>
                                <th> Year </th>
                ...
                <h3 class="h2" id="rcorners2"  > Certifications / Course </h3>
                <table id="t1" class="cert">
                        <tr>
                                <th> Title </th>
                                <th> Year </th>
                ...
                <h3 class="h2" id="rcorners2" > Seminar </h3>
                <table id="t1" class="cert">
                        <tr>
                                <th> Title </th>
                                <th> Year </th>
                ...
                <h3 class="h2" id="rcorners2" > Conference </h3>
                <table id="t1" class="cert">
                        <tr>
                                <th> Title </th>
                                <th> Year </th>
                ...
                <h3 class="h2" id="rcorners2" > Paper Publications </h3>
                <table id="t1" class="cert">
                        <tr>
                                <th> Title </th>
                                <th> Year </th>
                ...
                <h3 class="h2" id="rcorners2"> Books </h3>
	        <table id="t1" class="cert">
		<tr>
			<th> Title </th>
			<th> Year </th>
		...
		?>
                ...
                <h3 class="h2" id="rcorners2"> Awards </h3>
	        <table id="t1" class="cert">
                <tr>
                        <th> Title </th>
			<th> Acedamic Year</th>
			...
			while($ad = mysqli_fetch_array($ar))
			{
                ...
                <h3 class="h2" id="rcorners2"> Patents </h3>'          
		<table id="t1" class="cert">'
                <tr>
                        <th> Title </th>
                ...
                while($pad = mysqli_fetch_array($par))
			{
                ...
                <h3 class="h2" id="rcorners2"> Memberships </h3>
	        <table id="t1" class="cert">
                <tr>
                        <th> Title </th>
			...
			while($merd = mysqli_fetch_array($mer))
			{
                ...
                <h3 class="h2" id="rcorners2"> Responsibilities </h3>
	        <table id="t1" class="cert">
                <tr>
                        <th> Description </th>
			<th> Level</th>
			...
			while($red = mysqli_fetch_array($rer))
			{
                ...
                <h3 class="h2" id="rcorners2"> Sponsored Projects </h3>
	        <table id="t1" class="cert">
                <tr>
                        <th> Title </th>
			<th> Sponsored by</th>
			...
			while($pjsd = mysqli_fetch_array($pjsr))
			{
                ...
                <h3 class="h2" id="rcorners2"> Consultancy Projects </h3>
	        <table id="t1" class="cert">
                <tr>
                        <th> Title </th>
			<th> Agency</th>
			...
			while($pjcd = mysqli_fetch_array($pjcr))
			{
                ...
                <h3 class="h2" id="rcorners2"> Skills </h3>
	        <table id="t1" class="cert">
                <tr>
                        <th> Type</th>
			<th> Name</th>
			...
			while($skd = mysqli_fetch_array($skr))
			{
					echo '<tr>
					<td> '.$skd["ctype"].' </td>
					<td> '.$skd["cname"].' </td>
