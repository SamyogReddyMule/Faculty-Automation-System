        ...
        if(isset($_POST['login']))
            {
                ...
                {
                    echo '<script>alert("Login Sucessfull"); location.href="adminb.php"</script>';
                }
                if($auid !== $u['auid'] || $apassword !== $u['apwd'])
                {
                    echo '<script>alert("Unique ID or Password doesnt match"); location.href="adminlogin.php"</script>';
                }
            }
        ?>
