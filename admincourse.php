...
<body>
    ...
    <?php
    	if(isset($_POST['add']))
		{
			...
			{
				echo '<script>alert("Faculty Details not Found"); location.href="admincourse.php";</script>'; 
			}
      }
		...
		if(mysqli_num_rows(mysqli_query($con, $uqsa2)) != 1)
		{
			echo '<script>alert("Please check the Faculty ID, it seem to have no data on that "); location.href="admincourse.php"</script>';
		}
	}
