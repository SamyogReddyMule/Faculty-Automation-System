...
<body>
	<?php
	 ...
	 <form class="f1" id="f1" action="" method="POST" style="display: none" enctype="multipart/form-data">
        ...
        <input class="i1" type="text" placeholder="Enter Address" name="cad" required> <br>
    	...
    	if(isset($_POST['add']))
		{
			...
			{
				$add = " INSERT INTO faculty_details set fuid='$ci', fname='$cn', fdob='$cy', fgen='$cl', fdes='$cs', fdep='$cd', fphn='$ce', femail='$cf', fpwd='$ci', fage='$ca', faddress='$cad' ";
		...
		if(isset($_GET['upd0']) && $_GET['upd0'])
		{
			...
			<label class="l1" > Address </label>
	        <input class="i1" type="text" value="'.$wud["faddress"].'" placeholder="Enter Address" name="ucad" required> <br>
		...
		if(isset($_POST['change']))
		{
			...
			if($uci != $x)
			{
				...
				{
					$uadd = "UPDATE faculty_details set fuid='$uci', fname='$ucn', fdob='$ucy', fgen='$ucl', fdes='$ucs', fdep='$ucd', fphn='$uce', femail='$ucf', fage='$uca', faddress='$ucad' where fuid='$x' ";
			...
			if($uci == $x)
			{
       	 		$uadd = "UPDATE faculty_details set fuid='$uci', fname='$ucn', fdob='$ucy', fgen='$ucl', fdes='$ucs', fdep='$ucd', fphn='$uce', femail='$ucf', faddress='$ucad' where fuid='$x' ";
       	 		if(mysqli_query($con, $uadd))
				{
					echo '<script>alert("Updated Successfully"); location.href="adminfacd.php";</script>';
				}
