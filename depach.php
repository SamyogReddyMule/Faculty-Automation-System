...
<body>
	...
	?>
        ...
        <?php
		$f1 = " SELECT fuid, fname FROM faculty_details where fdep='$dep' ";
        ...
        <?php
		$f2 = " SELECT fuid, fname FROM faculty_details where fdep='$dep' ";
		...
		<?php
		$f3 = " SELECT fuid, fname FROM faculty_details where fdep='$dep' ";
