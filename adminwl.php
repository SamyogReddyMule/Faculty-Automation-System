...
<body>
	<?php
	 ...
	 <form class="f1" id="f1" action="" method="POST" style="display: none" enctype="multipart/form-data">
        ...
        <input class="i1" type="text" placeholder=" Enter Semester " name="cy" required> <br>
    	...
    	if(isset($_POST['add']))
		{
			...
			if(mysqli_num_rows(mysqli_query($con, $qsa2)) != 1)
			{
				echo '<script> alert("Some Error at Faculty ID"); location.href = "adminwl.php"; </script>';
			}
		}
		if(isset($_GET['upd0']) && $_GET['upd0'] && isset($_GET['upd1']) && $_GET['upd1'] && isset($_GET['upd2']) && $_GET['upd2'])
		{
        	...
        	<label class="l1" > Semester </label>
        	<input class="i1" type="text" value="'.$wud["wsem"].'" placeholder=" Enter Semester " name="ucy" required> <br>
