...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 31, 2023 at 04:52 AM
...
('Sir C R Reddy College of Engineering', 'Assistant Professor', '2022', '2023', 'CRRCSE01', '1'),
...
('CRRCSE01', 'Samyog', '2000-08-04', 'Male', 'Assistant Professor', 'CSE', '9440065209', 'karumanchi.poornasai50@gmail.com', 'CRRCSE01', '22 Years', 'Vijayawada'),
('CRRCSE02', 'Prasad', '2000-10-02', 'Female', 'Professor', 'CSE', '9848621256', 'ndeviharshitha@gmail.com', 'CRRCSE02', '22 Years', 'Eluru'),
('CRRIT01', 'Uma', '2002-11-06', 'Female', 'Associate Professor', 'IT', '9182530642', 'skthanuz@gmail.com', 'CRRIT01', '20 Years', 'Guntur'),
('CRRIT02', 'Ganesh', '2000-05-16', 'Male', 'Assistant Professor', 'IT', '6918654795', 'ssaisatyanarayana@gmail.com', 'CRRIT02', '22 Years', 'Remalle');

-- --------------------------------------------------------

--
-- Table structure for table `faculty_images`
--
...
--
-- Dumping data for table `faculty_images`
--

INSERT INTO `faculty_images` (`fuid`, `fimage`) VALUES
('CRRCSE01', 0x4352542e6a706567);
...
INSERT INTO `materials` (`cuid`, `cname`, `csem`, `cyear`, `csubject`, `cfile`) VALUES
('CRRIT01', 'R19', '4-1', '2021-22', 'python', 'CRRIT01-Cambridge IELTS 02.pdf');
...
('CRRIT01', 'CRR', 'Sponsered', 'python', '120250', '2018-2023', 'Ongoing', 'CRRIT01-Cambridge ielts 7 .pdf'),
