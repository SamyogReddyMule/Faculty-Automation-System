...
<body>
	...
	<form class="f1" id="f1" action="" method="POST" style="display: none;" enctype="multipart/form-data">
	        ...
	        <input class="i1" type="text" name="uca" value="<?php echo $dd['faddress']; ?>" required> <br>
	...
	if(isset($_POST['upd']))
		{
			...
			$wu1 = "UPDATE faculty_details SET fname='$ucn', fdob='$ucy', fgen='$ucs', fage='$uag', fphn='$uce', femail='$ucf', faddress='$uca' where fuid='$uid' ";
