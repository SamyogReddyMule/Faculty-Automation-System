...
<html lang="en" >
    <head>
        ...
        <title>IT Faculty Login Page</title>
    ...
    <body >
        <div class="d2" style="justify-content: center;">
            ...
            session_start();
            include 'db.php';
            include 'fedloginmenu.php';
            if(isset($_POST['login']))
            {
                $fuid = $_POST['uid'];
                $fpassword = $_POST['pass'];
                $_SESSION['id'] = $_POST['uid'];
                $sql = "SELECT *FROM faculty_details where fuid='$fuid' and fpwd='$fpassword' AND fdep='FED'";
